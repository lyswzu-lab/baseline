...
parser.add_argument('-9 m', '--model', default='ResNet-101', type=str, help="The model to be ran according to ./models package")
...
parser.add_argument('-ds', '--data-set', default='', type=str, help="Data set [nih, chexpert,mimic]")
